...
java -Xms1024M -Xmx2048M -Xmn1536M -Xss512k -Denv=fat -Dfat_meta=http://192.168.12.150:1666 -Dapollo.cluster=uat-longhui -classpath $CONFIG_DIR:$LIB_JARS $MAIN_CLASS | tee -a /logs/$SERVICE_NAME/std_out.log