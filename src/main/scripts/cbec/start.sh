...
java -Xms1024M -Xmx2048M -Xmn1536M -Xss512k -Dapp.id=${PROJECT_NAME}"_"${SERVICE_NAME} -Denv=pro -Dpro_meta=http://192.168.22.143:80 -Dapollo.cluster=cbec -classpath $CONFIG_DIR:$LIB_JARS $MAIN_CLASS | tee -a /logs/$SERVICE_NAME/std_out.log